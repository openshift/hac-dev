...
import IntegrationTestDetailsPage from '../SnapshotDetailsPage';
...
jest.mock('../../components/SnapshotDetails/SnapshotDetailsView', () => () => {
  return <div data-test="snapshot-details-page" />;
});
...
describe('SnapshotDetailsPage', () => {
  beforeEach(() => {
    useParamsMock.mockReturnValue({ snapshotName: 'my-test', appName: 'my-app' });
  ...
  it('should render integration test details page', () => {
    ...
    screen.getByTestId('snapshot-details-page');
  });
});
