...
import EditReleasePlanPage from '../EditReleasePlanPage';
...
describe('EditReleasePlanPage', () => {
  ...
  it('should show the spinner when access check is not loaded', () => {
    ...
    namespaceRenderer(<EditReleasePlanPage />, 'test-ns', {
      workspace: 'test-ws',
    });
  ...
  it('should show error state if resource is found but cannot be loaded', () => {
