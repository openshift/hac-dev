...
const RenderComponent: React.FC<TextAreaProps & { forwardedRef: React.Ref<HTMLInputElement> }> = ({
  label,
  helpText,
  required,
  onChange,
...
const renderFunction = (props: TextAreaProps, ref: React.Ref<HTMLInputElement>) => (
...
> = React.forwardRef<HTMLInputElement, TextAreaProps>(renderFunction);
