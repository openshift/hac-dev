...
describe('tekton-results', () => {
  ...
  describe('createTektonResultsUrl', () => {
    it('should create minimal URL', () => {
      expect(createTektonResultsUrl('test-ws', 'test-ns', [DataType.PipelineRun])).toEqual(
        '/plugins/tekton-results/workspaces/test-ws/apis/results.tekton.dev/v1alpha2/parents/test-ns/results/-/records?order_by=create_time+desc&page_size=30&PartialResponse=true&fields=records.name%2Crecords.data.value.apiVersion%2Crecords.data.value.kind%2Crecords.data.value.spec.taskRef.name%2Crecords.data.value.spec.taskRef.params%2Crecords.data.value.spec.containers%2Crecords.data.value.spec.status%2Crecords.data.value.metadata.annotations%2Crecords.data.value.metadata.labels%2Crecords.data.value.metadata.name%2Crecords.data.value.metadata.namespace%2Crecords.data.value.metadata.uid%2Crecords.data.value.metadata.creationTimestamp%2Crecords.data.value.metadata.ownerReferences%2Crecords.data.value.status.conditions%2Crecords.data.value.status.pipelineResults%2Crecords.data.value.status.taskResults%2Crecords.data.value.status.podName%2Crecords.data.value.status.taskSpec.description%2Crecords.data.value.status.results%2Crecords.data.value.status.startTime%2Crecords.data.value.status.completionTime%2Crecords.data.value.status.pipelineSpec.tasks%2Crecords.data.value.status.pipelineSpec.finally%2Crecords.data.value.status.containerStatuses&filter=data_type+in+%5B%22tekton.dev%2Fv1.PipelineRun%22%5D',
      );
      expect(createTektonResultsUrl('test-ws', 'test-ns', [DataType.TaskRun])).toEqual(
        '/plugins/tekton-results/workspaces/test-ws/apis/results.tekton.dev/v1alpha2/parents/test-ns/results/-/records?order_by=create_time+desc&page_size=30&PartialResponse=true&fields=records.name%2Crecords.data.value.apiVersion%2Crecords.data.value.kind%2Crecords.data.value.spec.taskRef.name%2Crecords.data.value.spec.taskRef.params%2Crecords.data.value.spec.containers%2Crecords.data.value.spec.status%2Crecords.data.value.metadata.annotations%2Crecords.data.value.metadata.labels%2Crecords.data.value.metadata.name%2Crecords.data.value.metadata.namespace%2Crecords.data.value.metadata.uid%2Crecords.data.value.metadata.creationTimestamp%2Crecords.data.value.metadata.ownerReferences%2Crecords.data.value.status.conditions%2Crecords.data.value.status.pipelineResults%2Crecords.data.value.status.taskResults%2Crecords.data.value.status.podName%2Crecords.data.value.status.taskSpec.description%2Crecords.data.value.status.results%2Crecords.data.value.status.startTime%2Crecords.data.value.status.completionTime%2Crecords.data.value.status.pipelineSpec.tasks%2Crecords.data.value.status.pipelineSpec.finally%2Crecords.data.value.status.containerStatuses&filter=data_type+in+%5B%22tekton.dev%2Fv1.TaskRun%22%5D',
      );
    });
  ...
  describe('getTaskRuns', () => {
    ...
    it('should query tekton results with options', async () => {
      ...
      expect(commonFetchJSONMock).toHaveBeenCalledWith(
        '/plugins/tekton-results/workspaces/test-ws/apis/results.tekton.dev/v1alpha2/parents/test-ns/results/-/records?order_by=create_time+desc&page_size=30&page_token=test-token&PartialResponse=true&fields=records.name%2Crecords.data.value.apiVersion%2Crecords.data.value.kind%2Crecords.data.value.spec.taskRef.name%2Crecords.data.value.spec.taskRef.params%2Crecords.data.value.spec.containers%2Crecords.data.value.spec.status%2Crecords.data.value.metadata.annotations%2Crecords.data.value.metadata.labels%2Crecords.data.value.metadata.name%2Crecords.data.value.metadata.namespace%2Crecords.data.value.metadata.uid%2Crecords.data.value.metadata.creationTimestamp%2Crecords.data.value.metadata.ownerReferences%2Crecords.data.value.status.conditions%2Crecords.data.value.status.pipelineResults%2Crecords.data.value.status.taskResults%2Crecords.data.value.status.podName%2Crecords.data.value.status.taskSpec.description%2Crecords.data.value.status.results%2Crecords.data.value.status.startTime%2Crecords.data.value.status.completionTime%2Crecords.data.value.status.pipelineSpec.tasks%2Crecords.data.value.status.pipelineSpec.finally%2Crecords.data.value.status.containerStatuses&filter=data_type+in+%5B%22tekton.dev%2Fv1.TaskRun%22%2C%22tekton.dev%2Fv1beta1.TaskRun%22%5D+%26%26+data.metadata.labels%5B%22test%22%5D+%3D%3D+%22a%22+%26%26+data.metadata.labels%5B%22mtest%22%5D+%3D%3D+%22ma%22+%26%26+count+%3E+1',
      );
    });
  });
