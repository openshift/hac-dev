export const mockPipelineRuns = [
  {
    ...
    metadata: {
      ...
      labels: {
        ...
        'appstudio.openshift.io/build': 'true',
        'appstudio.openshift.io/component': 'basic-node-js',
        'appstudio.openshift.io/type': 'build',
        'appstudio.openshift.io/version': '0.1',
  ...
  },
  {
    ...
    metadata: {
      ...
      generation: 1,
      labels: {
        'build.appstudio.openshift.io/application': 'nodejs',
        'build.appstudio.openshift.io/build': 'true',
        'build.appstudio.openshift.io/component': 'go-sample',
        'build.appstudio.openshift.io/type': 'build',
        'build.appstudio.openshift.io/version': '0.1',
        'appstudio.openshift.io/application': 'nodejs',
        'appstudio.openshift.io/build': 'true',
        'appstudio.openshift.io/component': 'go-sample',
        'appstudio.openshift.io/type': 'build',
        'appstudio.openshift.io/version': '0.1',
