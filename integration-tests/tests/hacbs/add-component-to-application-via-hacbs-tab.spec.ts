...
describe('Create Components using the HACBS UI', () => {
    ...
    const integrationTestNames = ['my-test-1', 'my-test-2', 'my-test-3', 'my-test-4', 'my-optional-test'];
    const integrationTestMetadata = [integrationTestNames[4], 'quay.io/kpavic/test-bundle:pipeline', pipelineName, 'test.appstudio.openshift.io/optional=true', applicationName];
    ...
    describe('Explore Integration Tests Tab', () => {
        ...
        it("Add a new Integration Test using 'Actions' dropdown, and mark it as Optional for release", () => {
            ...
            integrationTestsTabPage.checkRowValues(integrationTestNames[4], containerImage, 'Optional', pipelineName);
        });
